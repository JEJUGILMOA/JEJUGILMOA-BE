...
public enum PlanErrorCode implements BaseCode {
    ...
    WAYPOINT_VISIT_TOO_FAST(HttpStatus.BAD_REQUEST, "PLAN400_21", "이전 방문 인증 장소와의 거리에 비해 이동 시간이 너무 짧습니다."),
    TRIP_NOT_CANCELLABLE(HttpStatus.BAD_REQUEST, "PLAN400_22", "진행중인 여행만 중단할 수 있습니다.");
