...
public enum ImageUploadErrorCode implements BaseCode {
    ...
    OBJECT_NOT_FOUND(HttpStatus.NOT_FOUND, "IMAGE404_1", "업로드된 이미지 객체를 찾을 수 없습니다."),
    ...
    OBJECT_VERIFICATION_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "IMAGE500_2", "업로드된 이미지 객체를 확인하지 못했습니다."),
    READ_URL_PRESIGN_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "IMAGE500_3", "이미지 조회 URL을 생성하지 못했습니다.");
