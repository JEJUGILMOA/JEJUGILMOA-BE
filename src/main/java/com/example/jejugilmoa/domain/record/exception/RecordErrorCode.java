...
public enum RecordErrorCode implements BaseCode {
    ...
    RECORD_THUMBNAIL_TARGET_MISMATCH(HttpStatus.BAD_REQUEST, "RECORD400_7", "썸네일 이미지는 해당 여행 기록에 포함된 이미지여야 합니다."),
    ...
    RECORD_SELF_FAVORITE_NOT_ALLOWED(HttpStatus.FORBIDDEN, "RECORD403_4", "본인의 여행 기록은 즐겨찾기할 수 없습니다."),
    RECORD_FAVORITE_ALREADY_EXISTS(HttpStatus.CONFLICT, "RECORD409_2", "이미 즐겨찾기한 여행 기록입니다."),
